...
public class CancelServiceImpl implements CancelService {
    ...
    public CancelServiceImpl(ContextRepository contextRepository, OndcWebClient ondcWebClient, CancelReasonRepo cancelReasonRepo) {
    ...
    @Override
    public ResponseEntity<?> sendCancelRequest(String domain, String type, String transactionId, Long cancellationReasonId, String orderId, String description) {

        try{
            CancelRequest cancelRequest = createCancelRequest(domain,transactionId,cancellationReasonId, orderId,description);
    ...
    public CancelRequest createCancelRequest(String domain,String transactionId, Long cancellationReasonId,String orderId, String description) {
        ...
        CancelRequest.Context.Location.Country country = new CancelRequest.Context.Location.Country();
        country.setCode(contextDetail.getLocation_country_code());
        location.setCountry(country);
        CancelRequest.Context.Location.City city = new CancelRequest.Context.Location.City();
        ...
        CancelRequest.Message.Descriptor descriptor = new CancelRequest.Message.Descriptor();
